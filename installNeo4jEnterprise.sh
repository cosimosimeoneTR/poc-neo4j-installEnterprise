...
rm -rf neo4j-enterprise-2.3.1-unix.tar.gz    neo4j-enterprise-2.3.1                                                   && \
wget -O neo4j-enterprise-2.3.1-unix.tar.gz  http://neo4j.com/artifact.php?name=neo4j-enterprise-2.3.1-unix.tar.gz     && \
...
sudo rm -rf /var/lib/neo4j/README.txt && sudo mv README.txt /var/lib/neo4j/       && sudo chown -R neo4j:adm /var/lib/neo4j      && \
...
echo "That's all Folks! Please start server now..."
